...
const OpenGraph = () => {
  ...
  const openGraphData = useMemo(() => {
    ...
    if (_.has(OPEN_GRAPH, url)) {
      return OPEN_GRAPH[url];
    }

    return OPEN_GRAPH.DEFAULT;
  }, [asPath]);
  ...
  return (
    <Head>
      ...
      <meta property="og:url" content="https://www.pindirectshop.com/" />
      ...
      <meta property="twitter:url" content="https://www.pindirectshop.com/" />
